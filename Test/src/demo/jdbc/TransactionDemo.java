...
public class TransactionDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO MySchema.Employees (Name, Salary, Region) VALUES ('Bill',     10000, 'Flowerpot 1')");
            st.executeUpdate("INSERT INTO MySchema.Employees (Name, Salary, Region) VALUES ('Ben',      20000, 'Flowerpot 2')");
