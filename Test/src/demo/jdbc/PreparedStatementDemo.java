...
public class PreparedStatementDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PreparedStatement ps = cn.prepareStatement("INSERT INTO MySchema.Employees (Name, Salary, Region) VALUES (?, ?, ?)");
            ...
            ps = cn.prepareStatement("UPDATE MySchema.Employees SET Salary = Salary * ? WHERE Region = ?");
